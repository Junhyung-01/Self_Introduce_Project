...
const ContentPage = ({ title, type, onBack, onNavigate }) => {
  const contentMap = {
    ...
    identity2: {
      ...
      subtitle: 'Who am I? - 2',
      text: [
        '물론 처음부터 이런 성격은 아니였습니다. 어린 시절의 저는 밖에 나가 노는 것을 좋아하고 저 스스로 무언가를 성취하는 것을 좋아했던 때도 있었습니다.',
    ...
    identity3: {
      ...
      subtitle: 'Who am I? - 3',
      text: [
        '진짜 문제는 저렇게 갈등이 심화되어도 제 의견은 묵살된채 결국 부모님의 의견을 따라야 하는 상황이 된다는 것이였습니다. 이런 갈등을 반복하다보니 결국 저는 부모님과 대립하는 것을 포기했고, 감정소모 할 일 없이 부모님이 시키는 대로 사는 것이 편하다는 것을 알게 되었습니다.',
        '이런 이유로 저는 수동적인 삶을 살며 학창시절을 보냈고, 아쉽게도 영재고 과학고에 진학하는 것은 실패했지만, 이 때 공부했던 것을 토대로 논술전형 지원에 성공해 동국대학교에 오게 되었습니다.'
      ],
      nextPage: null,
      prevPage: 'identity2'
    },
